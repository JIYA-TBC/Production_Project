...
<div id="chat-container" class="container">
    <div class="row">
        <div class="col-12">
            ...
            <h1 class="text-center text-pink">Chat here</h1>
            <div id="chat-box"></div>
            <form id="message-form" action="message.php" method="POST">
                <div id="message-box-container" class="input-group">
                    <input type="text" id="message-box" name="message" class="form-control" placeholder="Enter your message...">
