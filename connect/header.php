<header>
		...
		<div class="top-bar">
			<div class="content-topbar flex-sb-m h-full container">
				<div class="left-top-bar">
					Post-Partum health care system
				</div>
				<div class="right-top-bar flex-w h-full">
					<a href="faqs.php" class="flex-c-m trans-04 p-lr-25">
						Help & FAQs
					</a>
		...
		<div class="wrap-menu-desktop">
			<nav class="limiter-menu-desktop container">
				...
				<div class="menu-desktop">
					<ul class="main-menu">
						<li class="">
							<a href="index.php" style="color: #000; font-size: 15px;"><span class="fa fa-home"></span> Home</a>
						</li>
						...
						<li class="por" style="color: black; font-size: 15px;">
							...
							<ul class="sub-menu">
								<li><a href="login.php" style="color: black;"><span class="fa fa-sign-in"></span> Login</a></li>
								<li><a href="register.php" style="color: black;"><span class="fa fa-edit"></span> Register</a></li>
							</ul>
						</li>
	...
	<div class="wrap-header-mobile">
		...
		<div class="logo-mobile">
			<a href="index.php"><img src="images/icons/mainlogo.png" alt="IMG-LOGO"></a>
		</div>
	...
	<div class="menu-mobile">
		<ul class="topbar-mobile">
			...
			<li>
				<div class="right-top-bar flex-w h-full">
					<a href="faqs.php" class="flex-c-m p-lr-10 trans-04">
						Help & FAQs
					</a>
    ...
    <div class="container-search-header">
        ...
        <form class="wrap-search-header flex-w p-l-15">
            <button class="flex-c-m trans-04" style="color: black;">
...
<div class="wrap-header-cart js-panel-cart">
	...
	<div class="header-cart flex-col-l p-l-65 p-r-25">
		...
		<div class="header-cart-content flex-w js-pscroll posthead">
			...
			<p>
				The website should aim to create a sense of community among new mothers, allowing them to connect with each other and share their experiences. This can help to reduce feelings of isolation and provide emotional support.
			</p>
