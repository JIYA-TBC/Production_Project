	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1 text-black" >
									mother's care
								</h2>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/slide22.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="images/index-back.jpg" alt="IMG-BANNER" style="height: 100%;">
						...
						<a href="login.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								...
								Resources for People Who Are Pregnant and/or Breastfeeding
								</span>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 more">
					...
					<p>
					At our Post-Partum care website, we believe that experience and innovation are key to providing the best possible care for new mothers and their babies. Our team includes experienced healthcare professionals who have worked with countless new mothers and understand the challenges they face during the postpartum period.
					</p>
					<p>
					We also prioritize innovation, constantly seeking new and better ways to deliver information and support to new mothers. We use the latest technology to create an engaging and user-friendly platform, with interactive features such as online classes and forums where new mothers can connect with each other and share their experiences.
					</p>
				</div>
...
<!--===============================================================================================-->
	...
	<script>
		$('.gallery-lb').each(function() { // the containers for all your galleries
			$(this).magnificPopup({
		        delegate: 'a', // the selector for gallery itemF
		        type: 'image',
		        gallery: {
		        	enabled:true
		        },
