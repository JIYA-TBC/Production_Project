...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['report_id'])) {
    ...
    $query = "DELETE FROM report_bookapp WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: bookapp_log.php?status=success");
    } else {
        // Redirect to the bookapp_log page with error message
        header("Location: bookapp_log.php?status=error");
    }
    ...
    header("Location: bookapp_log.php");
}
?>
