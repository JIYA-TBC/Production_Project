...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <a href="download_csv_ml.php" class="btn btn-primary mb-3">Download Report as CSV</a>
    ...
    <?php if (isset($_GET['status'])) : ?>
        <?php if ($_GET['status'] == 'success') : ?>
            <script>
                alert("Mother removed successfully.");
            </script>
                                ...
                                <tbody>
                                    <?php foreach ($changesData as $change) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="post" action="delete_mother.php">
