...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <a href="download_csv_dl.php" class="btn btn-primary mb-3">Download Report as CSV</a>
                                ...
                                <tbody>
                                    <?php foreach ($changesData as $change) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $change['use_r']; ?></td>
                                            <td><?php echo $change['phone']; ?></td>
                                            <td><?php echo $change['address']; ?></td>
                                            <td>
