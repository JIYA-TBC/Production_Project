...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <a href="download_csv_qr.php" class="btn btn-primary mb-3">Download Report as CSV</a>
                                ...
                                <tbody>
                                    <?php foreach ($changesData as $change) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $change['questdate']; ?></td>
                                            <td><?php echo $change['question']; ?></td>
                                            <td><?php echo $change['fullname']; ?></td>
                                            <td><?php echo $change['ans']; ?></td>
                                            <td><?php echo $change['email']; ?></td>
                                            <td><?php echo $change['status']; ?></td>
                                            <td>
                                                <form method="post" action="delete_queries.php">
                                                    <input type="hidden" name="report_id" value="<?php echo $change['id']; ?>">
                                                    <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                                                </form>
                                            </td> <!-- New delete button in the Action column -->
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
