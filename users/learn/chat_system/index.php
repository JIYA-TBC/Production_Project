...
<head>
    ...
    <style>
        ...
        #chat-box {
            ...
            /* Adjusted height to be 80% of the view height minus padding */
            overflow-y: scroll;
        ...
        .message {
            ...
            /* Light pink message background */
        }

        .message strong {
            color: #d63384;
            /* Dark pink for usernames */
        }

        h1 {
            color: #d63384;
            /* Dark pink for the header */
            text-align: center;
            margin-bottom: 20px;
        }
    </style>
    ...
    <div id="chat-container" class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1 class="text-center text-pink">Chat with Mothers</h1>
                <div id="chat-box"></div>
